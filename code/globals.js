...
buildingPlans = {
    ...
    guard: [{
        ...
        },
        {
            //Level 4 (max 1300)
            minEnergy: 900,
            body: [MOVE, MOVE, MOVE, MOVE, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, HEAL]
        },
        {
            //Level 5 (max 1750)
            minEnergy: 1220,
            body: [TOUGH, TOUGH, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, HEAL]
        },
        {
            //Level 6 (max 2300)
            minEnergy: 1220,
